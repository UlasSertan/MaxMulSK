...
// =============================================================================
// EXPERIMENT F2-ZAPRES -- byte-for-byte F2 except that pack_B_streaming is
// declared __arm_preserves("za"). Mc/Kc, both packing pipelines, the compute
// schedule and the C writeback are untouched.
//
