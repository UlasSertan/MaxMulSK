#include "sme-1x4-bstream-ilv2.hpp"
...
// =============================================================================
// SME 1x4, B streamed, one memory op per TWO svmopa (svld1_f32_x2)
//
...
//   * svmopa are NEVER left in long back-to-back runs. Here: at most two in a row, split by an svld1_f32_x2.
...
namespace SMEKernels1x4BStreamIlv2 {
            ...
            for (size_t ir = 0; ir < M; ir += M_step) {
                ...
                svzero_za();
                    if (K_main >= GRP) {
                        ...
                        svfloat32x2_t q0_lo = svld1_f32_x2(pg2, bsrc + 0 * N + 0 * SVL);
                        svfloat32x2_t q0_hi = svld1_f32_x2(pg2, bsrc + 0 * N + 2 * SVL);
                        svfloat32x2_t q1_lo = svld1_f32_x2(pg2, bsrc + 1 * N + 0 * SVL);
                        svfloat32x2_t q1_hi = svld1_f32_x2(pg2, bsrc + 1 * N + 2 * SVL);
                        svfloat32x2_t q2_lo = svld1_f32_x2(pg2, bsrc + 2 * N + 0 * SVL);
                        svfloat32x2_t q2_hi = svld1_f32_x2(pg2, bsrc + 2 * N + 2 * SVL);
                        ...
                        svfloat32x2_t q3_lo = svld1_f32_x2(pg2, bsrc + 3 * N + 0 * SVL);
                        svfloat32x2_t q3_hi = svld1_f32_x2(pg2, bsrc + 3 * N + 2 * SVL);
                        ...
                        for (size_t k = 0; k + GRP < K_main; k += GRP) {
                            ...
                            svmopa_za32_f32_m(0, pg, pg, a0, svget2_f32(q0_lo, 0));
                            svmopa_za32_f32_m(1, pg, pg, a0, svget2_f32(q0_lo, 1));
                            svfloat32x2_t q3_lo = svld1_f32_x2(pg2, bsrc + 3 * N + 0 * SVL);
                            svmopa_za32_f32_m(2, pg, pg, a0, svget2_f32(q0_hi, 0));
                            svmopa_za32_f32_m(3, pg, pg, a0, svget2_f32(q0_hi, 1));
                            svfloat32x2_t q3_hi = svld1_f32_x2(pg2, bsrc + 3 * N + 2 * SVL);

                            // k-step 1: consume q1, fetch k+4 into q0 (used 12 svmopa later).
                            svmopa_za32_f32_m(0, pg, pg, a1, svget2_f32(q1_lo, 0));
                            svmopa_za32_f32_m(1, pg, pg, a1, svget2_f32(q1_lo, 1));
                            q0_lo = svld1_f32_x2(pg2, bsrc + 4 * N + 0 * SVL);
                            svmopa_za32_f32_m(2, pg, pg, a1, svget2_f32(q1_hi, 0));
                            svmopa_za32_f32_m(3, pg, pg, a1, svget2_f32(q1_hi, 1));
                            q0_hi = svld1_f32_x2(pg2, bsrc + 4 * N + 2 * SVL);

                            // k-step 2: consume q2, fetch k+5 into q1 (used 12 svmopa later).
                            svmopa_za32_f32_m(0, pg, pg, a2, svget2_f32(q2_lo, 0));
                            svmopa_za32_f32_m(1, pg, pg, a2, svget2_f32(q2_lo, 1));
                            q1_lo = svld1_f32_x2(pg2, bsrc + 5 * N + 0 * SVL);
                            ...
                            svmopa_za32_f32_m(2, pg, pg, a2, svget2_f32(q2_hi, 0));
                            svmopa_za32_f32_m(3, pg, pg, a2, svget2_f32(q2_hi, 1));
                            q1_hi = svld1_f32_x2(pg2, bsrc + 5 * N + 2 * SVL);

                            // k-step 3: consume q3, fetch k+6 into q2 (used 12 svmopa later).
                            svmopa_za32_f32_m(0, pg, pg, a3, svget2_f32(q3_lo, 0));
                            svmopa_za32_f32_m(1, pg, pg, a3, svget2_f32(q3_lo, 1));
                            q2_lo = svld1_f32_x2(pg2, bsrc + 6 * N + 0 * SVL);
                            svmopa_za32_f32_m(2, pg, pg, a3, svget2_f32(q3_hi, 0));
                            svmopa_za32_f32_m(3, pg, pg, a3, svget2_f32(q3_hi, 1));
                            q2_hi = svld1_f32_x2(pg2, bsrc + 6 * N + 2 * SVL);
                        ...
                        q3_lo = svld1_f32_x2(pg2, bsrc + 3 * N + 0 * SVL);
                        q3_hi = svld1_f32_x2(pg2, bsrc + 3 * N + 2 * SVL);
                        svmopa_za32_f32_m(0, pg, pg, a0, svget2_f32(q0_lo, 0));
                        svmopa_za32_f32_m(1, pg, pg, a0, svget2_f32(q0_lo, 1));
                        svmopa_za32_f32_m(2, pg, pg, a0, svget2_f32(q0_hi, 0));
                        svmopa_za32_f32_m(3, pg, pg, a0, svget2_f32(q0_hi, 1));
