...
//
// SME 1x4, B streamed from memory. Same five svld1_f32_x4 per group as the
// depth-3 kernel, only placed inside the svmopa stream instead of at the
// k-step boundaries. Longest back-to-back svmopa run: 3.
//
